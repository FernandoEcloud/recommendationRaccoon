                    ...
                    function (err) {
                      client.del(tempAllLikedSet, function (err) {
                        client.zcard(recommendedZSet, function (err, length) {
                          console.log(recommendedZSet, 0, length, 99, config.numOfRecsStore, 1)
                          client.zremrangebyrank(recommendedZSet, 0, parseInt(length) - parseIng(config.numOfRecsStore) - 1, function (err) {
                            cb();
                          });
                        });
                      });
